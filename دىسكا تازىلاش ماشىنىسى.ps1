...
#GUI Variables
$FormTitleText = "جىم تايلېرنىڭ دىسكا تازىلاش ماشىنىسى (PowerShellEngineer.com)"
$SelectDiskLabelText = "دىسكىنى تاللاڭ:"
$FreeSpaceLabelText = "ھەقسىز بوشلۇق (گىگابايت):"
$TotalSpaceLabelText = "ئومۇمىي بوشلۇق (گىگابايت):"
$JunkFoundLabelText = "ئەخلەت تېپىلدى (گىگابايت):"
$CleanDiskBtnText = "دىسكىنى تازىلاش * ھۆججەتلەرنى ئۆچۈرۈش *"
$SpaceCleanedLabelText = "تازىلانغان بوشلۇق (گىگابايت):"
$LogFileLabelText = "خاتىرە ھۆججىتى تېپىلدى: $abcdefg"
$CreditLabelText = "جىم تايلېرنىڭ قوليازمىسى - PowerShellEngineer.com"
$LogFileLocatedText = "خاتىرە ھۆججىتى تېپىلدى"
$AnalyzingDriveText = "قوزغاتقۇچنى تەھلىل قىلىش ..."
$BrowsersAreRunningText = "توركۆرگۈچلەر ئىجرا بولۇۋاتىدۇ ... ئىشلەتكۈچىگە خەۋەر قىلىڭ ..."
$PleaseCloseBrowsersText = "بارلىق توركۆرگۈلەرنى تاقاپ قايتا سىناڭ."
$CleaningDriveText = "تازىلاش دىسكىسى ..."
